...
{
    [Fact]
    public void MelonLoaderProject_ReferencesUnityImGuiAndLegacyInputAssemblies()
    {
        string root =
            GetRepositoryRoot();
        ...
        Assert.Contains(
            "$(DataCenterRoot)\\MelonLoader\\Il2CppAssemblies\\UnityEngine.InputLegacyModule.dll",
            source,
            StringComparison.Ordinal
        );
    ...
    [Fact]
    public void StatusOverlay_UsesDirectUnityInputAndImGuiWithProofLogging()
    {
        string root =
            GetRepositoryRoot();
